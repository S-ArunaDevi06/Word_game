...
bellatrix_image = pygame.image.load("umbridge.png").convert_alpha()
...
# Dialogue setup
bellatrix_dialogue = "Hem-hem!I wouldn't want to give you... detention."
